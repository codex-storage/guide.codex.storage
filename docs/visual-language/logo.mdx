...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    title="Mark - Black"
    forceDownload
    previewSrc="/logo/Mark/Large/PREVIEW-Codex-Mark-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Mark/Large/Codex-Mark-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Mark/Large/Codex-Mark-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    title="Mark - White"
    forceDownload
    previewSrc="/logo/Mark/Large/PREVIEW-Codex-Mark-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Mark/Large/Codex-Mark-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Mark/Large/Codex-Mark-White-Large.svg"
      }
    ]}
  />
</div>
...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/Large/PREVIEW-Codex-Vertical lockup-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Large/Codex-Vertical lockup-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Large/Codex-Vertical lockup-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/Large/PREVIEW-Codex-Vertical lockup-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Large/Codex-Vertical lockup-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Large/Codex-Vertical lockup-White-Large.svg"
      }
    ]}
  />
</div>
...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Horizontal lockup/Large/PREVIEW-Codex-Horizontal lockup-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Horizontal lockup/Large/Codex-Horizontal lockup-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Horizontal lockup/Large/Codex-Horizontal lockup-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Horizontal lockup/Large/PREVIEW-Codex-Horizontal lockup-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Horizontal lockup/Large/Codex-Horizontal lockup-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Horizontal lockup/Large/Codex-Horizontal lockup-White-Large.svg"
      }
    ]}
  />
</div>
